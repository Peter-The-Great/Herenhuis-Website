...
//here we give one variable to a index of slides and we will show that slide when that is needed.
var slideIndex = 1;
showSlides(slideIndex);//show slides will turn into slide index and will work as an array from there.
...
function showSlides(n) {
  ...
  //this will make dots (pointers to specific elements)
